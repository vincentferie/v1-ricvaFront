...
import {DataTableDirective, PageEvent, SortEvent} from './datatable.directive';
...
describe('DataTable directive tests', ()=> {
  let datatable: DataTableDirective;
  let fixture: ComponentFixture<TestComponent>;

  beforeEach(()=> {
    TestBed.configureTestingModule({
      declarations: [DataTableDirective, TestComponent]
    });
    fixture = TestBed.createComponent(TestComponent);
    datatable = fixture.debugElement.query(By.directive(DataTableDirective)).injector.get(DataTableDirective) as DataTableDirective;
