...
export class ConfigurationComponent implements OnInit {
  ...
  scroll = (): void => {
    if (this.headerFixedLayout === false) {
      (this.document.querySelector('#nav-ps-next') as HTMLElement).style.maxHeight = 'calc(100vh)';
      const el = this.document.querySelector('.pcoded-navbar.menupos-fixed') as HTMLElement;
    ...
    } else if (this.document.querySelector('.pcoded-navbar').hasAttribute('style')) {
      this.document.querySelector('.pcoded-navbar.menupos-fixed').removeAttribute('style');
    }
  }
  ...
  setHeaderBackColor(color) {
    ...
    (this.document.querySelector('body') as HTMLElement).style.background = color;
  }

  // change main layout
  setLayout(layout) {
    this.isConfig = true;
    this.document.querySelector('.pcoded-navbar').classList.remove('menu-light');
    this.document.querySelector('.pcoded-navbar').classList.remove('menu-dark');
    this.document.querySelector('body').classList.remove('able-pro-dark');

    this.layoutType = layout;
    if (layout === 'menu-light') {
      this.document.querySelector('.pcoded-navbar').classList.add(layout);
      this.setHeaderBackground('background-blue');
    }
    if (layout === 'dark') {
      this.setHeaderBackground('background-blue');
      this.document.querySelector('body').classList.add('able-pro-dark');
    }
    if (layout === 'reset') {
      this.reset();
    }
  ...
  changeRtlLayout(flag) {
    if (flag) {
      this.document.querySelector('body').classList.add('able-pro-rtl');
    } else {
  ...
  changeMenuFixedLayout(flag) {
    setTimeout(() => {
      if (flag) {
        this.document.querySelector('.pcoded-navbar').classList.remove('menupos-static');
        this.document.querySelector('.pcoded-navbar').classList.add('menupos-fixed');
        if (this.nextConfig.layout === 'vertical') {
          (this.document.querySelector('#nav-ps-next') as HTMLElement).style.maxHeight = 'calc(100vh - 60px)'; // calc(100vh - 70px) amit
        }
        window.addEventListener('scroll', this.scroll, true);
        window.scrollTo(0, 0);
      } else {
        this.document.querySelector('.pcoded-navbar').classList.add('menupos-static');
        this.document.querySelector('.pcoded-navbar').classList.remove('menupos-fixed');
        if (this.nextConfig.layout === 'vertical') {
          (this.document.querySelector('#nav-ps-next') as HTMLElement).style.maxHeight = 'calc(100%)'; // calc(100% - 70px) amit
        }
        if (this.nextConfig.layout === 'vertical') {
  ...
  changeHeaderFixedLayout(flag) {
    if (flag) {
      this.document.querySelector('.pcoded-header').classList.add('headerpos-fixed');
    } else {
  ...
  changeBoxLayout(flag) {
    if (flag) {
      this.document.querySelector('body').classList.add('container');
      this.document.querySelector('body').classList.add('box-layout');
    } else {
  ...
  setHeaderBackground(background) {
    ...
    this.document.querySelector('body').classList.remove('background-blue');
    this.document.querySelector('body').classList.remove('background-red');
    this.document.querySelector('body').classList.remove('background-purple');
    this.document.querySelector('body').classList.remove('background-info');
    this.document.querySelector('body').classList.remove('background-green');
    this.document.querySelector('body').classList.remove('background-dark');
    this.document.querySelector('body').classList.remove('background-grd-blue');
    this.document.querySelector('body').classList.remove('background-grd-red');
    this.document.querySelector('body').classList.remove('background-grd-purple');
    this.document.querySelector('body').classList.remove('background-grd-info');
    this.document.querySelector('body').classList.remove('background-grd-green');
    this.document.querySelector('body').classList.remove('background-grd-dark');
    this.document.querySelector('body').classList.remove('background-img-1');
    this.document.querySelector('body').classList.remove('background-img-2');
    this.document.querySelector('body').classList.remove('background-img-3');
    this.document.querySelector('body').classList.remove('background-img-4');
    this.document.querySelector('body').classList.remove('background-img-5');
    this.document.querySelector('body').classList.remove('background-img-6');

    this.document.querySelector('body').classList.add(background);
  }
}
